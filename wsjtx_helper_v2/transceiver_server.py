...
serial_port = ""
for w in a:
    if "cafe" in w.hwid.lower() or "2e8a" in w.hwid.lower():
...
def transmit():
    if not current_msg:
        ...
        return
    print("> TX!")
    sport.write(b';TX1;')  # turn on ppt
    sport.write(b';GO;')  # trigger transmission
...
def main():
    ...
    while True:
        # sport.write(b';TX1;')
        # sport.write(b';MECQ VU3CER MK68;')
        sport.write(b';RR;')
        r = sport.read()
        if r == b'R':
